...
*/
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_LEAD, KC_RBRC,  KC_N,    KC_M,    TD(TD_COMMA), TD(TD_DOT),  KC_SLSH,  KC_RSFT, \
                        KC_LALT, OSM(MOD_LSFT), MO(_LOWER), KC_SPC, KC_ENT, MO(_RAISE), KC_BSPC, KC_RGUI \
),
...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX, KC_UNDS, KC_LBRC, KC_RBRC, KC_BSLS, KC_TRNS, \
                             _______, _______, _______, _______, _______,  _______, _______, _______\
),
...
[_ADJUST] = LAYOUT( \
VRSN,    XXXXXXX, TG(_GAME),  TG(_GAME_ESDF), XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RESET,   \
...
KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_LEAD, KC_SPC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                      KC_LALT, KC_SPC, KC_SPC, KC_SPC, KC_ENT, TG(_GAME), KC_BSPC, KC_RGUI \
),
...
KC_Z, KC_LCTRL,   KC_X,    KC_C,    KC_V,    KC_B,   KC_SPC,   KC_SPC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                         KC_LALT, KC_SPC, KC_SPC, KC_SPC,        KC_ENT, TG(_GAME_ESDF), KC_BSPC, KC_RGUI \
)
